...
from app.controllers.user_controllers import login_user, logout_user, update_user, toggle_user_status, get_user_logs
...
def login():
    ...
    return jsonify({"msg":"Algo salio mal al intentar iniciar sesion, revise sus claves"}), 400
...
def update(user_id):
    ...
    return jsonify({"msg":"Algo salio mal al intentar actualizar el usuario"}), 400
...
def change_status(user_id):
    ...
    if user:
        return jsonify({"msg":"Estatus actualizado", "activo":user.to_dict()["state"]}), 200
